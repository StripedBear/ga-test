...
Development environment: Visual Studio, programming language: C++. The Forge was used for graphics, SoLoud for sound, additional code was written in C # and Python for utilitarian purposes.
